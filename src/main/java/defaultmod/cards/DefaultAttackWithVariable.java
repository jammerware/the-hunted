...
public class DefaultAttackWithVariable extends CustomCard {
     ...
     *
     * In order to understand how image paths work, go to defaultmod/TheHunted.java, Line ~140 (Image path section).
     *
    ...
    public static final String ID = TheHunted.makeID("DefaultAttackWithVariable");
