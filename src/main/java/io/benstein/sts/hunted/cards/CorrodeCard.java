...
public class CorrodeCard extends CustomCard {
    ...
    public void use(AbstractPlayer player, AbstractMonster monster) {
        ...
        if (monster.currentBlock > 0) {
            ...
            LoggerService.getLogger(this.getClass()).debug("We're gonna remove " + blockToRemove + " as per the rules n stuf.");
            AbstractDungeon
                .actionManager
                .addToBottom(new LoseBlockAction(monster, player, blockToRemove));
        }
